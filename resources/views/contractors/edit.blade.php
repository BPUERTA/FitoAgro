                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('contractors.update', $contractor) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $contractor->nombre) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="cuit" id="cuit" value="{{ old('cuit', $contractor->cuit) }}" 
                        ...
                        <div class="mb-4">
                            <label for="activo" class="flex items-center">
                                <input type="checkbox" name="activo" id="activo" value="1" 
                                       ...
                                       {{ old('activo', $contractor->activo) ? 'checked' : '' }}>
