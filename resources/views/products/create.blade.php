                    ...
                    <form method="POST" action="{{ route('products.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="marca_comercial" id="marca_comercial" value="{{ old('marca_comercial') }}" 
                            ...
                            <div>
                                ...
                                <input type="text" name="principio_activo" id="principio_activo" value="{{ old('principio_activo') }}" 
                            ...
                            <div>
                                ...
                                <input type="text" name="concentracion" id="concentracion" value="{{ old('concentracion') }}" 
                            ...
                            <div>
                                ...
                                <select name="formulacion" id="formulacion" 
                                    ...
                                    <optgroup label="Formulaciones Líquidas">
                                        <option value="SL (Concentrado Soluble)" {{ old('formulacion') == 'SL (Concentrado Soluble)' ? 'selected' : '' }}>SL (Concentrado Soluble)</option>
                                        <option value="EC (Concentrado Emulsionable)" {{ old('formulacion') == 'EC (Concentrado Emulsionable)' ? 'selected' : '' }}>EC (Concentrado Emulsionable)</option>
                                        <option value="SC (Suspensión Concentrada)" {{ old('formulacion') == 'SC (Suspensión Concentrada)' ? 'selected' : '' }}>SC (Suspensión Concentrada)</option>
                                        <option value="OD (Dispersión en Aceite)" {{ old('formulacion') == 'OD (Dispersión en Aceite)' ? 'selected' : '' }}>OD (Dispersión en Aceite)</option>
                                        <option value="SE (Suspo-emulsión)" {{ old('formulacion') == 'SE (Suspo-emulsión)' ? 'selected' : '' }}>SE (Suspo-emulsión)</option>
                                        <option value="ME (Micro-emulsión)" {{ old('formulacion') == 'ME (Micro-emulsión)' ? 'selected' : '' }}>ME (Micro-emulsión)</option>
                                        <option value="CS (Suspensión de Encapsulados)" {{ old('formulacion') == 'CS (Suspensión de Encapsulados)' ? 'selected' : '' }}>CS (Suspensión de Encapsulados)</option>
                                    </optgroup>
                                    <optgroup label="Formulaciones Sólidas">
                                        <option value="WG / WDG (Gránulos Dispersables en Agua)" {{ old('formulacion') == 'WG / WDG (Gránulos Dispersables en Agua)' ? 'selected' : '' }}>WG / WDG (Gránulos Dispersables en Agua)</option>
                                        <option value="SG (Gránulos Solubles)" {{ old('formulacion') == 'SG (Gránulos Solubles)' ? 'selected' : '' }}>SG (Gránulos Solubles)</option>
                                        <option value="WP (Polvo Mojable)" {{ old('formulacion') == 'WP (Polvo Mojable)' ? 'selected' : '' }}>WP (Polvo Mojable)</option>
                                        <option value="SP (Polvo Soluble)" {{ old('formulacion') == 'SP (Polvo Soluble)' ? 'selected' : '' }}>SP (Polvo Soluble)</option>
                                    </optgroup>
                                    <optgroup label="Fertilizantes">
                                        <option value="Fertilizante Líquido" {{ old('formulacion') == 'Fertilizante Líquido' ? 'selected' : '' }}>Fertilizante Líquido</option>
                                        <option value="Fertilizante Sólido" {{ old('formulacion') == 'Fertilizante Sólido' ? 'selected' : '' }}>Fertilizante Sólido</option>
                                        <option value="Fertilizante Foliar" {{ old('formulacion') == 'Fertilizante Foliar' ? 'selected' : '' }}>Fertilizante Foliar</option>
                                        <option value="Fertilizante Biológico" {{ old('formulacion') == 'Fertilizante Biológico' ? 'selected' : '' }}>Fertilizante Biológico</option>
                                    </optgroup>
                                </select>
                                @error('formulacion')
                                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select name="clase_toxicidad" id="clase_toxicidad" 
                                    ...
                                    <option value="">Seleccionar...</option>
                                    <option value="I" {{ old('clase_toxicidad') == 'I' ? 'selected' : '' }}>I</option>
                                    <option value="II" {{ old('clase_toxicidad') == 'II' ? 'selected' : '' }}>II</option>
                                    <option value="III" {{ old('clase_toxicidad') == 'III' ? 'selected' : '' }}>III</option>
                                    <option value="IV" {{ old('clase_toxicidad') == 'IV' ? 'selected' : '' }}>IV</option>
                                    <option value="V" {{ old('clase_toxicidad') == 'V' ? 'selected' : '' }}>V</option>
                                </select>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="uso_declarado" id="uso_declarado" value="{{ old('uso_declarado') }}" 
                            ...
                            <div>
                                ...
                                <select name="um_dosis" id="um_dosis" 
                                    ...
                                    <option value="">Seleccionar...</option>
                                    <option value="Cc" {{ old('um_dosis') == 'Cc' ? 'selected' : '' }}>Cc</option>
                                    <option value="Gr" {{ old('um_dosis') == 'Gr' ? 'selected' : '' }}>Gr</option>
                                </select>
                                @error('um_dosis')
                                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="um_total" id="um_total" 
                                    ...
                                    <option value="">Seleccionar...</option>
                                    <option value="Lt" {{ old('um_total') == 'Lt' ? 'selected' : '' }}>Lt</option>
                                    <option value="Kg" {{ old('um_total') == 'Kg' ? 'selected' : '' }}>Kg</option>
                                </select>
                                @error('um_total')
                                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                                @enderror
