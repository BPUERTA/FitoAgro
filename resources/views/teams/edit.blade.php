                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('teams.update', $team) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-2">
                                @php
                                    $servicios = is_string($team->servicio) ? json_decode($team->servicio, true) ?? [] : (is_array($team->servicio) ? $team->servicio : []);
                                    $oldServicios = old('servicio', $servicios);
                                @endphp
                                <label class="flex items-center">
                                    <input type="checkbox" name="servicio[]" value="fumigacion" 
                                           ...
                                           {{ is_array($oldServicios) && in_array('fumigacion', $oldServicios) ? 'checked' : '' }}>
                                    <span class="ml-2 text-sm text-gray-700">Fumigación</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="checkbox" name="servicio[]" value="fertilizacion_liquida" 
                                           class="rounded border-gray-300 text-green-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                           {{ is_array($oldServicios) && in_array('fertilizacion_liquida', $oldServicios) ? 'checked' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tipo_servicio" id="tipo_servicio" value="{{ old('tipo_servicio', $team->tipo_servicio) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="dominio" id="dominio" value="{{ old('dominio', $team->dominio) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="matricula" id="matricula" value="{{ old('matricula', $team->matricula) }}" 
                        ...
                        <div class="mb-4">
                            <label for="activo" class="flex items-center">
                                <input type="checkbox" name="activo" id="activo" value="1" 
                                       class="rounded border-gray-300 text-green-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" 
                                       {{ old('activo', $team->activo) ? 'checked' : '' }}>
